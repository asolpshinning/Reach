...
let Bool = 'Bool';
let UInt = 'UInt';
const cenCtc = '0xBc3B835bA0710F0ACD1e5568b228eed849aAFAB5';
...
function Deliver() {
 ...
 //
        ...
        await Promise.all([
            backendCtc.Creator(ctcCreator, {
                getParams: (msg) => {
                    ...
                    return {NFT: `0x8d43F477F386228AC23CEcFC53B9CC9883c19BF4`, Bridger: `0x1a1fA0479a7C63b86b548750B70601b048502B7f` }
  ...
  const deployToken = async() => {
        ...
        //Launch tokens
        const bT = await reach.launchToken(accCreator, `fineToken2`, `TOKN2`, {decimals: 0, supply: 1000000});
        ...
        alert(`NFT/token ID (copy and use for smart contract): ${reach.bigNumberToNumber(bT.id._hex)}`);
...
//
  return (
    <div className={styles.container}>
      <h1>Just some NFT contract I am testing</h1>
      ...
      <div> <h3> Your Wallet Balance: {balance} ETH </h3>  </div>
